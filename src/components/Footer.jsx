      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            <svg width="24" height="24" viewBox="0 0 36 36" className="opacity-60">
              <circle cx="18" cy="18" r="16" fill="none" stroke="#00D4FF" strokeWidth="1.5"/>
              <circle cx="18" cy="2" r="3" fill="#00D4FF"/>
            </svg>
            <span className="font-display font-bold text-sm text-[#F0F4FF]/40">CodeOrbits</span>
          </div>

          <div className="flex items-center gap-6 text-sm text-[#F0F4FF]/40">
            ...
            <a href="#work" className="hover:text-[#00D4FF] transition-colors">Work</a>
            <a href="#contact" className="hover:text-[#00D4FF] transition-colors">Contact</a>
          </div>

          <div className="flex items-center gap-4">
            <a href="https://www.linkedin.com/in/salim-khan-41906b286/" target="_blank" rel="noopener noreferrer" className="text-[#F0F4FF]/40 hover:text-[#00D4FF] transition-colors">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
            </a>
            <a href="https://github.com/salimkhan585786" target="_blank" rel="noopener noreferrer" className="text-[#F0F4FF]/40 hover:text-[#00D4FF] transition-colors">
            ...
            <a href="https://wa.me/917021414700" target="_blank" rel="noopener noreferrer" className="text-[#F0F4FF]/40 hover:text-[#00D4FF] transition-colors">
        ...
        <address itemScope itemType="https://schema.org/LocalBusiness" className="mt-8 pt-6 border-t border-[#00D4FF]/5 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-[#F0F4FF]/30 not-italic">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <a href="mailto:support@codeorbits.in" className="hover:text-[#00D4FF] transition-colors">support@codeorbits.in</a>
            <span className="text-[#F0F4FF]/10">|</span>
